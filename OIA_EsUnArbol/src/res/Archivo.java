...
public class Archivo {
    ...
    private final static String direc = "archivos/";
	...
	try {
	    fw = new FileWriter(direc + nombre + ".out");
	    pw = new PrintWriter(fw);

	    pw.print(re.getRespuesta());
	...
	try {
	    fw = new FileWriter(direc + nombre + ".in");
	    pw = new PrintWriter(fw);
